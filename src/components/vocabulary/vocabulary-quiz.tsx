...
export function VocabularyQuiz({
  ...
  const shuffledChoices = useMemo(() => choices, [choices]);
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-base">单词测试</CardTitle>
      </CardHeader>
      <CardContent className="space-y-5">
        <div className="rounded-lg bg-muted p-4">
          <p className="text-xs font-medium uppercase tracking-[0.18em] text-muted-foreground">Meaning</p>
          <p className="mt-2 text-3xl font-semibold tracking-tight">{word}</p>
